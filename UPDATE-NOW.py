...
def swag():
	samsung = random.choice(["SM-J320F"])
	ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/211.0.0.35.138;FBBV/42370301;FBDM/{density=2.0,width=1280,height=1280};FBLC/en_US;FBCR/Salaam Telecom;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-J320F;FBSV/8.3.4;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
	return ua
